    ...
    <body>
        <div class="navbar theme_color1">
            <div class="nav-wrap-left">
                <?php if (( $this->_var['class'] != 'settings' && $this->_var['class'] != 'account' && $this->_var['class'] != 'investor' ) || ( $this->_var['class'] == 'settings' && $this->_var['act'] == 'index' )): ?>
                     <a href="<?php echo $this->_var['APP_URL']; ?>" class="logo"><img src="<?php echo $this->_var['site_logo']; ?>"></a>
                <?php else: ?>
                <a onclick="window.history.go(-1);" class="back">
